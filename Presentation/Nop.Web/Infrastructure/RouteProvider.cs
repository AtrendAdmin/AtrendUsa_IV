...
namespace Nop.Web.Infrastructure
{
    public partial class RouteProvider : IRouteProvider
    {
        public void RegisterRoutes(RouteCollection routes)
        {
            ...
            //nowcommerce signup
            routes.MapLocalizedRoute("NowCommerceSignUp",
                "nowcommercesignup",
                new { controller = "Common", action = "NowCommerceSignUp" },
                new[] { "Nop.Web.Controllers" });

            //dealer-login
            routes.MapLocalizedRoute("DealerLogin",
                            "dealer-login",
                            new { controller = "Common", action = "DealerLogin" },
                            new[] { "Nop.Web.Controllers" });
